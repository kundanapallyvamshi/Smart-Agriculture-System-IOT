...
organization = "egdyr7" #replace the ORG ID deviceType = "crop-out"#replace the Device type wi deviceId = "1000111"#replace Device ID authMethod = "token" 
authToken = "vamshi123" #Replace the authtoken 
